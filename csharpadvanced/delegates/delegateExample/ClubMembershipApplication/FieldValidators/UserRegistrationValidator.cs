...
public class UserRegistrationValidator : IFieldValidor
{
    ...
    RequiredFieldValidDel _requiredValidDel = null;
    ...
    public void InitialiseValidatorDelegates()
    {
        ...
        _requiredValidDel = CommonFieldValidorFunctions.RequiredFieldValidDel;
        _stringLenthValidDel = CommonFieldValidorFunctions.StringLengthValidDel;
        ...
        _compareFieldsValidDel = CommonFieldValidorFunctions.CompareFieldValidDel;
    }
